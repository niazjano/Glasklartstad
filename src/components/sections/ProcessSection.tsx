    ...
    <section className="py-24 sm:py-32" aria-labelledby="process-heading">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          <h2 id="process-heading" className="text-3xl font-bold tracking-tight text-[#081B3A] sm:text-4xl">
            Så fungerar det
          </h2>
        ...
        <ol className="mt-16 grid gap-8 md:grid-cols-3">
          {PROCESS_STEPS.map((step) => (
            <li key={step.step} className="card-premium p-8">
              <span className="flex h-12 w-12 items-center justify-center rounded-full bg-[#081B3A] text-lg font-bold text-white">
                {step.step}
              </span>
              <h3 className="mt-6 text-xl font-semibold text-[#081B3A]">
                {step.title}
              </h3>
